...
def main():
    ...
    # Create users
    user5 = taser.create_user(1, "Alice")
    user3 = taser.create_user(2, "Bob")

    # Create projects
    project2 = taser.create_project(1, "Project A")
    project7 = taser.create_project(2, "Project B")

    # Create tasks
    task6 = taser.create_task(1, "Task 1 for Project A", 1)
    task8 = taser.create_task(2, "Task 2 for Project A", 1)
    task9 = taser.create_task(3, "Task 1 for Project B", 2)

    # Assign projects to users
    taser.assign_project_to_user(1, 1)
    taser.assign_project_to_user(2, 2)
