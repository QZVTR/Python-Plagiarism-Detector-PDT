class User:
    ...
    def assign_project(self, p):
        self.deAssignedProjects.append(p)
...
class ProjectManager:
    ...
    def create_user(self, i_d, me_na):
        user = User(i_d, me_na)
        self.people[i_d] = user
        return user

    def create_project(self, id_project, eman):
        a = Project(id_project, eman)
        self.proj[id_project] = a
        return a
