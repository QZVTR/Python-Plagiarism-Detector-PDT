...
def main():
    ...
    while running:
        ...
        drawSquares(screen, 200, 600, 50, 50, "A*", aSt, sPoint, finishPoint, obstacles)
        drawSquares(
            screen, 350, 600, 50, 50, "BFS", bfs, sPoint, finishPoint, obstacles
        )
        drawSquares(
            screen, 500, 600, 50, 50, "DFS", dfs, sPoint, finishPoint, obstacles
        )
        ...
        if sPoint and finishPoint:
            distance, path = dij(sPoint, finishPoint, obstacles)
            for node in path:
